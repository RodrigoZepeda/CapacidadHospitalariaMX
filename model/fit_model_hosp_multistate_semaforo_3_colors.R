...
stan_fname        <- "model/BModel_ARMA_semaforo_v2.stan"
...
semaforo <- read_csv("https://github.com/claudiodanielpc/covid19/raw/master/semaforo_covidmx.csv",
  ...
  mutate(nom_ent = if_else(nom_ent == "Veracruz de Ignacio de la Llave", 
                           "Veracruz de Ignacio de La Llave", nom_ent)) 
...
chains = 2; iter_warmup = 250; nsim = 500; pchains = 2; hmin = 3; hmax = 4;
